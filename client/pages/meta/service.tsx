...
const TermsOfService: NextPage = () => (
  <div className="prose mx-auto my-12 dark:prose-invert">
    ...
    <p>
      The Reactive Website app stores and processes personal data that you have provided to us, to provide my Service.
      ...
      programs, compromise your phone&apos;s security features and it could mean that the Reactive Website app won&apos;t
      work properly or at all.
    </p>

    <p>
      Certain functions of the app require the app to have an active internet connection. The connection can be Wi-Fi or
      provided by your mobile network provider, but we cannot take responsibility for the app not working at full
    ...
    <p>
      The app is currently available on Android – the requirements for the system(and for any additional systems we
      decide to extend the availability of the app to) may change, and you&apos;ll need to download the updates if you
      want to keep using the app. We do not promise that it will always update the app so that it is relevant to you
      and/or works with the Android version that you have installed on your device. However, you promise to always
      accept updates to the application when offered to you, We may also wish to stop providing the app, and may
      terminate use of it at any time without giving notice of termination to you. Unless we tell you otherwise, upon
      any termination, (a) the rights and licenses granted to you in these terms will end; (b) you must stop using the
    ...
    <p>If you have any questions or suggestions about the terms of service, do not hesitate to contact us.</p>
  </div>
);
